...
//#################################################
var BASE_URL = "/static/libs/ppvod/";
...
jQuery(function () {
    ...
    uploader.on('fileQueued', function (file) {
        ...
        var html = "";
        html += "<div style=\"background:#fff;border-radius:4px;padding:10px 15px;margin-top:10px;height:120px;\" id=\"" + file.id + "\" data-size=\"" + file.size + "\" data-time=\"" + new Date().getTime() + "\">";
        ...
        html += "    </div>";
        html += "</div>";
        html += "<p style=\"margin-top:10px;color:red;\">提醒：视频需等待帖子审核后才能播放，请勿重复上传！</p>";
        $list.append(html);
    });
// 文件上传过程中创建进度条实时显示。
